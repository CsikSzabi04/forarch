...
exports.registerSuggestionProvider = registerSuggestionProvider;
...
function registerSuggestionProvider() {
    // optional initialization
}
function getSuggestions(currentFile, currentLine) {
    ...
    try {
        ...
        const scores = fixSessions.map((s) => {
